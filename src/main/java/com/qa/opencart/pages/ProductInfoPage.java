...
public class ProductInfoPage {
	...
	public String getProductHeader(String mainProductName) {
		...
		String productHeader = util.doGetText(By.xpath(xpath));
	...
	public int getProductImagesCount() {
		...
		return util.waitForElementsToBeVisible(productImages, AppConstants.DEFAULT_LARGE_TIME_OUT).size();
	}
	
	public String getProductPageTitle(String productTitle) {
		return util.waitForTitleIs(AppConstants.DEFAULT_TIME_OUT, productTitle);
	}
	
	public String getProductPageURL(String searchKey) {
		return util.waitForUrlContains(AppConstants.DEFAULT_TIME_OUT, searchKey);
	}
